...
def main():
    rules = load_rules()
    excel_path = "/Users/openclaw/Downloads/B.xlsx"
    store_id = "store_b"
    ...
    with app.app_context():
        ...
        # Let's delete existing store_b transactions for 2026-01, 2026-02, 2026-03 to be safe if rerun
        db.execute("DELETE FROM transactions WHERE store_id=? AND month_key IN ('2026-01', '2026-02', '2026-03')", (store_id,))
        
        xls = pd.ExcelFile(excel_path)
        
        # Just process whatever month sheets exist or match 1月, 2月, 3月
        ...
        for sheet in target_sheets:
            ...
            for _, row in df.iterrows():
                ...
                amount_val = row.get('消費金額')
                if pd.isna(amount_val):
                    continue
                amount = float(amount_val)
                
                # force 2026 for this assignment
        ...
        db.commit()
    print("Import completed for Huwei 2026 Jan-Mar.")
